...
import 'package:doctor_dashboard_app/screens/doctor_register_form_screen.dart';
import 'package:doctor_dashboard_app/screens/edit_doctor_profile.dart';
import 'package:flutter/material.dart';

class DoctorProfileScreen extends StatefulWidget {
  const DoctorProfileScreen({super.key, this.documentSnapshot});
      ...
      body: widget.documentSnapshot == null
          ? Center(
              child: Column(
                ...
                children: [
                  const Text(
                    "Register yourself by clicking below",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 20,
                        color: Colors.green),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const DoctorRegisterFormScreen(),
                              ),
                            );
                          },
